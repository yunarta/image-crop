...
public class CropImage extends MonitoredActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        try {
            metaData = getPackageManager().getActivityInfo(getComponentName(), PackageManager.GET_ACTIVITIES | PackageManager.GET_META_DATA).metaData;
        } catch (PackageManager.NameNotFoundException e) {
            metaData = new Bundle();
        }

        requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(metaData.getInt("layout", R.layout.z_cropimage));
        ...
        findViewById(metaData.getInt("discard")).setOnClickListener(
        ...
        findViewById(metaData.getInt("save")).setOnClickListener(
                new View.OnClickListener() {
                    public void onClick(View v) {
                        onSaveClicked();
                    }
    ...
    private void startFaceDetection() {
        ...
        Util.startBackgroundJob(this, null,
                getResources().getString(metaData.getInt("runningFaceDetection", R.string.z_imagecrop_runningFaceDetection)),
                new Runnable() {
            public void run() {
    ...
    private void onSaveClicked() {
        ...
        if (myExtras != null && (myExtras.getParcelable("data") != null
            ...
            final int msdId = mSetWallpaper
                    ? metaData.getInt("imagecrop_wallpaper", R.string.z_imagecrop_wallpaper)
                    : metaData.getInt("imagecrop_savingImage", R.string.z_imagecrop_savingImage);
            Util.startBackgroundJob(this, null,
    ...
    Runnable mRunFaceDetection = new Runnable() {
        ...
        private void handleFace(FaceDetector.Face f) {
            ...
            HighlightView hv = new HighlightView(mImageView, metaData);
                ...
                public void run() {
                    ...
                    if (mNumFaces > 1) {
                        Toast t = Toast.makeText(CropImage.this,
                                metaData.getInt("imagecrop_multiface_crop_help", R.string.z_imagecrop_multiface_crop_help),
                                Toast.LENGTH_SHORT);
                        t.show();
                    }
                }
